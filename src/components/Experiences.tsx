...
const Experiences = () => {
  ...
  return (
    <div className='container mx-auto flex flex-col justify-between border-2 rounded-md sm:flex-row mt-6 mb-6 p-4 h-[450px] max-w-6xl new-mesh dark:dark-mesh dark:text-white shadow-lg'>
